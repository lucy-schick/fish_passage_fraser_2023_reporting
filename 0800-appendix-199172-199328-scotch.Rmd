...
In 2023, crossings `r as.character(my_site)` and `r as.character(my_site2)` were assessed with fish passage assessments [ADD_FRASER_REPORT]. These sites were prioritized for follow-up with habitat confirmation assessments due to the presence of high-value habitat observed upstream during the 2023 assessment [ADD_FRASER_REPORT].
