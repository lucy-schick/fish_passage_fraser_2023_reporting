...
In 2023, both crossings were assessed with fish passage assessments and prioritized for follow-up due to the presence of high-value habitat and a chinook observations documented adjacent to the downstream crossing in the FISS database [@norris2024smnorrisbcfishobs; @moe2024KnownBC]. A habitat confirmation assessment encompassing both sites was conducted in 2024. Downstream in Fraser Lake, white sturgeon, chinook, bull trout, rainbow trout, kokanee, and other species have been previously recorded [@norris2024smnorrisbcfishobs; @moe2024KnownBC].
...
PSCIS crossing 203297 was located approximately 150m upstream of Stella Road on a private road, where the culvert had a significant outlet drop and severe erosion at the inlet, creating a possible barrier to fish passage.
...
`r fpr::fpr_my_pscis_info()` is a small stream that flows into Fraser Lake, with a documented chinook observation near the outflow into the lake [@norris2024smnorrisbcfishobs; @moe2024KnownBC]. The downstream crossing on `r fpr_my_pscis_info(col_pull = road_name, site = my_site)` was ranked as passable; however, PSCIS crossing `r as.character(my_site2)` on `r fpr_my_pscis_info(col_pull = road_name, site = my_site2)` had a significant 1.35m outlet drop and presented a clear barrier to upstream fish passage. A further 150m upstream of Stella Road, PSCIS crossing 203297 was also a barrier to fish passage, with a 0.7m outlet drop and severe erosion obstructing the inlet. Fish sampling is recommended to determine whether fish are able to ascend past the `r fpr_my_pscis_info(col_pull = road_name, site = my_site2)` crossing. The crossing is a `r stringr::str_to_lower(fpr::fpr_my_priority_info(sit = my_site2, col_pull = priority))` priority for replacement.
