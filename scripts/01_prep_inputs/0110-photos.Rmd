...
#I think this assumes we have already populated pscis_phase2.xlsm with new PSCIS IDs, I think we should use pscis_phase1.xlsm instead - 
##use the pscis spreadsheet to make the folders to copy the photos to (d is dat)
# phase2 <- fpr::fpr_import_pscis(workbook_name = 'pscis_phase2.xlsm')

# cross reference table is stored in the sqlite - xref_pscis_my_crossing_modelled
...
#Double check they are there, then delete the old directories
