...
Chinook spawners have been documented at the confluence of Holliday Creek and the Fraser River in the [Pacific Salmon Explorer](https://www.salmonexplorer.ca/) [@salmonwatershedsprogram2025Spawnerabundance]. In 2004, chinook and bull trout were captured upstream and downstream of the `r fpr_my_pscis_info(col_pull = road_name, site = my_site)` crossing by Triton Environmental Consultants Ltd. [@manson2005Fishcollection]. 

<br>

Upstream of this crossing is the Holliday Creek Arch Protected Area, a small, 395-hectare protected area showcasing a 80 m wide and 18 m high natural stone arch [@HollidayCreekArchProtectedArea]. The park can be accessed via the [Natural Arch Trail](https://www.trailforks.com/trails/natural-arch-trail-742159/), which starts on Mt.Baker Mainline FSR near Highway 16 and climbs ~1000m to an alpine lookout [@HollidayCreekArchProtectedArea]. Outside of the park on the west side of the valley, the [Groeneveld Trail](https://www.trailforks.com/trails/groeneveld-trail/) also provides hiking access to beautiful views [@recreationsitesandtrailsbcGroeneveldtrail]. 
