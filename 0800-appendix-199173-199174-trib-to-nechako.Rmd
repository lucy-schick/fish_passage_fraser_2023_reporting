...
In 2023, both crossings were assessed with fish passage assessments and prioritized for follow-up due to the presence of high-value habitat. A habitat confirmation assessment encompassing both sites was conducted in 2024.
...
Aerial surveys were conducted with a remotely piloted aircraft and the resulting imagery was processed into orthomosaics, digital terrain models (dtm) and a digital surface models (dsm), for both PSCIS crossings `r as.character(my_site)` and `r as.character(my_site2)`. Imagery for PSCIS crossing `r as.character(my_site)` on `r fpr_my_pscis_info(col_pull = road_name, site = my_site)` is available to view and download `r if(gitbook_on){knitr::asis_output("in Figure \\@ref(fig:uav-ortho-199173)")}else(knitr::asis_output("here: [orthomosaic](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_orthophoto/odm_orthophoto.tif), [dtm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_dem/dtm.tif), [dsm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_dem/dsm.tif)"))`. Imagery for PSCIS crossing `r as.character(my_site2)` on `r fpr_my_pscis_info(col_pull = road_name, site = my_site2)` is available to view and download `r if(gitbook_on){knitr::asis_output("in Figure \\@ref(fig:uav-ortho-199174)")}else(knitr::asis_output("here: [orthomosaic](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_orthophoto/odm_orthophoto.tif), [dtm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_dem/dtm.tif), [dsm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_dem/dsm.tif)"))`. 

```{r eval = F}
# Use when dtm and dsm models are working again. 
# `r if(gitbook_on){knitr::asis_output("in Figures \\@ref(fig:uav-ortho-199173) - \\@ref(fig:uav-dtm-199173) - \\@ref(fig:uav-dsm-199173)")}else(knitr::asis_output("here: [orthomosaic](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_orthophoto/odm_orthophoto.tif), [dtm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_dem/dtm.tif), [dsm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_dem/dsm.tif)"))`.

# `r if(gitbook_on){knitr::asis_output("in Figures \\@ref(fig:uav-ortho-199174) - \\@ref(fig:uav-dtm-199174) - \\@ref(fig:uav-dsm-199174)")}else(knitr::asis_output("here: [orthomosaic](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_orthophoto/odm_orthophoto.tif), [dtm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_dem/dtm.tif), [dsm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_dem/dsm.tif)"))`.
```
...
```{r uav-dtm-199173-prep, eval = F}
viewer_url <- '<iframe src="https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_dem/dtm.tif" scrolling="no" title="UAV Viewer" width="100%" height="600" frameBorder="0"></iframe>'

knitr::asis_output(viewer_url)
```

```{r uav-dtm-199173, out.width = "0.01%", eval = F, fig.cap= my_caption}
my_photo = 'fig/pixel.png'

my_caption = paste0('Digital terrain model of PSCIS crossing ', my_site, '.')
...
```{r uav-dsm-199173-prep, eval = F}
viewer_url <- '<iframe src="https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199173_necr_trib_dog/odm_dem/dsm.tif" scrolling="no" title="UAV Viewer" width="100%" height="600" frameBorder="0"></iframe>'

knitr::asis_output(viewer_url)
```

```{r uav-dsm-199173, out.width = "0.01%", eval = F, fig.cap= my_caption}
my_photo = 'fig/pixel.png'

my_caption = paste0('Digital surface model of PSCIS crossing ', my_site, '.')
...
```{r uav-dtm-199174-prep, eval = F}
viewer_url <- '<iframe src="https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_dem/dtm.tif" scrolling="no" title="UAV Viewer" width="100%" height="600" frameBorder="0"></iframe>'

knitr::asis_output(viewer_url)
```

```{r uav-dtm-199174, out.width = "0.01%", eval = F, fig.cap= my_caption}
my_photo = 'fig/pixel.png'

my_caption = paste0('Digital terrain model of PSCIS crossing ', my_site2, '.')
...
```{r uav-dsm-199174-prep, eval = F}
viewer_url <- '<iframe src="https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199174_necr_trib_dog_settlement/odm_dem/dsm.tif" scrolling="no" title="UAV Viewer" width="100%" height="600" frameBorder="0"></iframe>'

knitr::asis_output(viewer_url)
```

```{r uav-dsm-199174, out.width = "0.01%", eval = F, fig.cap= my_caption}
my_photo = 'fig/pixel.png'

my_caption = paste0('Digital surface model of PSCIS crossing ', my_site2, '.')
