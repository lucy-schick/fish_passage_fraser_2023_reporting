...
At the time of the 2024 assessment, both crossings `r as.character(my_site)` and `r as.character(my_site2)` were un-embedded, non-backwatered and ranked as a `r fpr::fpr_my_pscis_info(col_pull = barrier_result) |>stringr::str_to_lower()` to upstream fish passage according to the provincial protocol [@moe2011Fieldassessment] (Tables \@ref(tab:tab-culvert-199171) - \@ref(tab:tab-culvert-7622)). Crossing `r as.character(my_site)` had a significant 0.9m outlet drop, while crossing `r as.character(my_site2)` had an even larger outlet drop of 1.15m, both of which likely inhibited fish passage.
