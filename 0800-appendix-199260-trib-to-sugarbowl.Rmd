...
Approximately 4.5km downstream of the crossing, near the confluence of Kenneth Creek and the Fraser River, chinook and bull trout have previously been recorded (Figure \@ref(fig:map-199260))[@norris2024smnorrisbcfishobs; @moe2024KnownBC]. At this same location, chinook spawners have been historically documented in the [Pacific Salmon Explorer](https://www.salmonexplorer.ca/) [@salmonwatershedsprogram2025Spawnerabundance].  
...
```{r tab-culvert-bcfp-199260, eval = F}
