...
The habitat upstream of `r as.character(my_site)` on `r fpr_my_pscis_info(col_pull = road_name, site = my_site)` was documented as low value for salmonid spawning and rearing and the crossing is rated as a low priority for replacement due to the intermittent nature of the stream approximately 200m upstream of `r fpr_my_pscis_info(col_pull = road_name, site = my_site)`. The culvert had been recently worked on with new cement poured inside of the pipe and riprap placed at the outlet.
