...
In 2023, crossing `r as.character(my_site)` was assessed with a fish passage assessments [ADD_FRASER_REPORT]. This site was prioritized for follow-up with habitat confirmation assessments due to the presence of high-value habitat observed upstream during the 2023 assessment [ADD_FRASER_REPORT]. Upstream of the `r fpr_my_pscis_info(col_pull = road_name, site = my_site)`, `r fpr::fpr_my_fish_sp()` have previously been recorded [@norris2024smnorrisbcfishobs; @moe2024KnownBC].
