...
PSCIS crossing `r as.character(my_site)` is located on a `r fpr::fpr_my_pscis_info()`, approximately 65km east of Prince George, BC. The crossing is located 3.7km upstream of the tributaries confluence with Kenneth Creek, which flows into the Fraser River approximately 9km downstream. The crossing is situated on `r fpr_my_pscis_info(col_pull = road_name, site = my_site)`, which is under the jurisdiction of the Ministry of Forests. The crossing is within the Morkill River watershed group. 
...
Upstream of `r fpr_my_pscis_info(col_pull = road_name, site = my_site)`, longnose sucker have previously been recorded [@norris2024smnorrisbcfishobs; @moe2024KnownBC]. Chinook spawners have been historically documented at the confluence of Kenneth Creek and the Fraser River in the [Pacific Salmon Explorer](https://www.salmonexplorer.ca/) [@salmonwatershedsprogram2025Spawnerabundance]. 
