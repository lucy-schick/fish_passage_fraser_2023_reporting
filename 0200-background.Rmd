...
Indigenous fisheries organizations, including individual First Nations, the Carrier Sekani Tribal Council, and the Upper Fraser Fisheries Conservation Alliance (UFFCA), are actively involved in fisheries management in the Nechako watershed. These organizations work to support conservation while ensuring the sustainability of Indigenous fisheries, which have cultural and subsistence importance.

<br>

### Chilako River  

The Chilako River (Tsalakoh) is a Nechako tributary with historic salmon populations, but fish passage barriers and low summer flows limit salmon migration. It provides habitat for Coho Salmon, Rainbow Trout, and Mountain Whitefish [@bcfishspecies2024].  

Key fisheries challenges:  

- Culverts and road crossings obstruct fish passage.  
- Summer low flows restrict available spawning and rearing habitat.  
- Coho Salmon are present in lower reaches, but populations are small and vulnerable to habitat degradation.  

### François Lake  

François Lake is one of the largest natural lakes in BC and supports landlocked Kokanee (O. nerka), as well as migratory Sockeye Salmon that access the lake via the Stellako River. François Lake is a key rearing area for juvenile salmon before migrating to the Fraser River [@bcfishspecies2024].  

Fisheries considerations:  

- Sockeye Salmon: A major spawning population for the Fraser system.  
- Lake Trout and Burbot: Resident species with stable populations.  
- Invasive species: Potential threats to native fish populations.  

### Morkill River  

The Morkill River, a tributary of the Upper Fraser, supports Bull Trout, Mountain Whitefish, and Rainbow Trout. It has limited salmon presence but contributes cold water inputs to the Fraser River, which may benefit migrating fish during warm summer months [@shaw_tuominenWaterQuality].  


### Fisheries Data  

Fisheries and Oceans Canada stock assessment data for salmon populations in the Fraser River watershed was accessed through the [NuSEDS-New Salmon Escapement Database System](https://open.canada.ca/data/en/dataset/c48669a3-045b-400d-b730-48aafe8c5ee6). A summary of escapement estimates for salmon-bearing watersheds in the Nechako River, Upper Fraser River, François Lake, Morkill River, and Chilako River regions is presented in Table X.  
