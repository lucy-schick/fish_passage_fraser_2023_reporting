...
An aerial survey was conducted with a remotely piloted aircraft and the resulting imagery was processed into an orthomosaic, digital terrain model (dtm) and a digital surface model (dsm), available to view and download `r if(gitbook_on){knitr::asis_output("in Figure \\@ref(fig:uav-ortho-199256)")}else(knitr::asis_output("here: [orthomosaic](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_orthophoto/odm_orthophoto.tif), [dtm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_dem/dtm.tif), [dsm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_dem/dsm.tif)"))`.

```{r eval = F}
# Use when dtm and dsm models are working again. 
# `r if(gitbook_on){knitr::asis_output("in Figures \\@ref(fig:uav-ortho-199256) - \\@ref(fig:uav-dtm-199256) - \\@ref(fig:uav-dsm-199256)")}else(knitr::asis_output("here: [orthomosaic](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_orthophoto/odm_orthophoto.tif), [dtm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_dem/dtm.tif), [dsm](https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_dem/dsm.tif)"))`.
```
...
```{r uav-dtm-199256-prep, eval = F}
viewer_url <- '<iframe src="https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_dem/dtm.tif" scrolling="no" title="UAV Viewer" width="100%" height="600" frameBorder="0"></iframe>'

knitr::asis_output(viewer_url)
```

```{r uav-dtm-199256, out.width = "0.01%", eval = F, fig.cap= my_caption}
my_photo = 'fig/pixel.png'
...
```{r uav-dsm-199256-prep, eval = F}
viewer_url <- '<iframe src="https://viewer.a11s.one/?cog=https://imagery-uav-bc.s3.amazonaws.com/fraser/nechacko/2024/199256_kenneth_hwy16/odm_dem/dsm.tif" scrolling="no" title="UAV Viewer" width="100%" height="600" frameBorder="0"></iframe>'

knitr::asis_output(viewer_url)
```

```{r uav-dsm-199256, out.width = "0.01%", eval = F, fig.cap= my_caption}
my_photo = 'fig/pixel.png'
